...
{
    class DurationLimitedFadingLight : Light
    {
        private BlinkingLightFadeState _fadeState = BlinkingLightFadeState.None;
        private float _durationTimer, _fadeTimer = -1.0f;
        ...
        public void TurnOn()
        {
            ...
            if(_fadeState == BlinkingLightFadeState.FadingOut || (_fadeState == BlinkingLightFadeState.None && !IsLightOn))
